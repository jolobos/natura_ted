...
<tr><th class="text-center bg-dark text-white-50" >Vendas de '.$mes.' de '.$ano.'</th></tr>
...
<tr><th class="text-center bg-dark text-white-50" colspan="2">Ranking de clientes no mes!!!!</th></tr>
<tr>
