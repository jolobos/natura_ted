...
<tr><th class="text-center bg-dark text-white-50" colspan="6">Vendas de '.$mes.' de '.$ano.'</th></tr>
...
<tr><th class="text-center bg-dark text-white-50" colspan="6">Ranking de produtos no mes!!!!</th></tr>
<tr>
